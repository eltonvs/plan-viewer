...
AI coding agents like [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Cursor](https://cursor.com), [Codex](https://openai.com/index/codex/), and others generate markdown implementation plans during the planning phase of complex development tasks. **Claude Plan Viewer** gives you a dedicated UI to browse, search, and read them — with rich markdown rendering, syntax highlighting, an interactive outline, and more.
...
Interactions feel responsive with subtle animations throughout:

- Outline panel slides in from the right
- Folder accordions expand and collapse with height transitions
- Implemented plan sections slide open when toggled
- The "Implemented" badge animates its width when toggling completion status
- Theme changes smoothly transition all colors
...
```bash
git clone https://github.com/eltonviana/claude-plan-viewer.git
